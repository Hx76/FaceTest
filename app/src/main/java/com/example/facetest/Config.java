...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    public static String apiKey = "oSjXNW8I5L6urMLiuVWXq5QK";
    public static String secretKey ="o2N5FVG5Fq8tNNeOtu1IQqBDnG2s6Rri";
    public static String licenseID = "FaceGet-face-android";
